...
namespace Laundry\Config;

use PDO;
use PDOException;

/**
 * Single shared PDO connection, configured from environment variables.
...
final class Database
{
     ...
     * planning/00-portfolio/ui-implementation-plan.md). Callers needing
     * dialect-specific SQL (e.g. OperatorController::prefer()'s upsert)
     * branch on this.
     */
    ...
    private static function connectMysql(): PDO
    {
        ...
        $name = getenv('DB_NAME') ?: 'laundry_co_ke';
